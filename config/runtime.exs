...
config :adam,
  ...
  thinker_model: System.get_env("ADAM_THINKER_MODEL") || "qwen3:14b",
  actor_model: System.get_env("ADAM_ACTOR_MODEL") || "qwen3:8b",
  embed_model: System.get_env("ADAM_EMBED_MODEL") || "nomic-embed-text",
  thinker_cost: to_float.(System.get_env("ADAM_THINKER_COST") || "0.012"),
